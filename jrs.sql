...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 19, 2024 at 11:31 AM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `notify_company_of_application` (IN `p_application_id` INT)   BEGIN
    ...
    (application_id, company_id, notification_time) 
    VALUES 
    (p_application_id, v_company_id, NOW());
END$$
...
(4, '2024-11-19 14:18:26', 'INSERT', 6),
(5, '2024-11-19 14:18:26', 'INSERT', 7),
(6, '2024-11-19 14:18:26', 'INSERT', 8);
...
(9, 'resume_alex.pdf', 8, 10, '2024-11-14', 'Under Review');
...
(3, 'siddu', 'sid@evilkilzer', '0000-00-00', 21, 4, 'afaef'),
...
(8, 'Alex Wong', 'alex.wong@email.com', '1991-09-25', 32, 107, 'Austin');
